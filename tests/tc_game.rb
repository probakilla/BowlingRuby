...
class GameTest < Test::Unit::TestCase
  ...
  def test_scenario
    @game.roll(5)
    assert_equal(5, @game.get_current_pins())
    @game.roll(2)
    assert_equal(3, @game.get_current_pins())
    assert_equal(7, @game.total_score())

    @game.roll(4)
    assert_equal(6, @game.get_current_pins())
    @game.roll(1)
    assert_equal(5, @game.get_current_pins())
    ...
    assert_equal(5, @game.get_current_pins())
    @game.roll(5)
    assert_equal(0, @game.get_current_pins())
    assert_equal(22, @game.total_score())

    @game.roll(2)
    assert_equal(8, @game.get_current_pins())
    @game.roll(3)
    assert_equal(5, @game.get_current_pins())
    ...
    assert_equal(6, @game.get_current_pins())
    @game.roll(2)
    assert_equal(4, @game.get_current_pins())
    ...
    @game.roll(1)
    assert_equal(9, @game.get_current_pins())
    @game.roll(1)
    assert_equal(8, @game.get_current_pins())
